...
def rays_from_camera(use_pixel_centers, h, w, focal, camtoworlds):
  """Create rays for each pixel in a collection of images."""
...
class Dataset(threading.Thread):
  ...
  def _generate_rays(self):
    ...
    origins, directions, viewdirs = rays_from_camera(self.use_pixel_centers,
